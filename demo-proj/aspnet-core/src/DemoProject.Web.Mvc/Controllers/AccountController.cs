...
using DemoProject.Web.Models.Account;
using DemoProject.Web.Views.Shared.Components.TenantChange;
...
public class AccountController : DemoProjectControllerBase
{
