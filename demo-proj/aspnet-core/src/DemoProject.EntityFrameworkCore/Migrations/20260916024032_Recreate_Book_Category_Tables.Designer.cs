...
namespace DemoProject.Migrations
{
    ...
    [Migration("20260916024032_Recreate_Book_Category_Tables")]
    partial class Recreate_Book_Category_Tables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DemoProject.Books.Book", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("ST_Book", null, t =>
                        {
                            t.HasCheckConstraint("CK_ST_Book_Price", "[Price] >= 0");
                        });
                });

            modelBuilder.Entity("DemoProject.Books.Category", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("ST_Category", (string)null);
                });
            ...
            modelBuilder.Entity("DemoProject.Books.Book", b =>
                {
                    b.HasOne("DemoProject.Books.Category", null)
                        .WithMany()
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("DemoProject.Books.Category", "Category")
                        .WithMany()
